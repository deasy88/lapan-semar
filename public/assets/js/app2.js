						...
						$("#feature-list tbody")
								.append(
										'<tr class="feature-row" id="'
												...
												+ '" lng="'
												+ layer.getLatLng().lng
												+ '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/kapal.png"></td><td class="feature-name">'
						...
						$("#feature-list tbody")
								.append(
										'<tr class="feature-row" id="'
												...
												+ '" lng="'
												+ layer.getLatLng().lng
												+ '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/ikan.png"></td><td class="feature-name">'
												+ layer.feature.properties.NAME
												+ '</td><td style="vertical-align: middle;"><i class="fa fa-chevron-right pull-right"></i></td></tr>');
					}
				}
...
var mapquestOSM = L
		.tileLayer(
				"https://{s}.mqcdn.com/tiles/1.0.0/osm/{z}/{x}/{y}.png",
				{
					maxZoom : 19,
 ...
 * add/remove kapals to markerClusters layer
 */
					...
					onEachFeature : function(feature, layer) {
						if (feature.properties) {
							var content = "<table class='table table-striped table-bordered table-condensed'>"
									+ "<tr><th>Tipe Kapal</th><td>"
									+ feature.properties.TIPE
									+ "</td></tr>"
									+ "<tr><th>Length x Lebar</th><td>"
									...
									+ "</td></tr>"
									+ "</td></tr>"
									+ "<tr><th>Kecepatan/Arah</th><td>"
									+ feature.properties.ARAH
									+ "</td></tr>"
									+ "<tr><th>Tujuan</th><td>"
									+ feature.properties.TUJUAN
									+ "</td></tr>"
									+ "<tr><th>Catat</th><td>"
									+ feature.properties.CATAT + "<table>";
							layer
									.on({
										click : function(e) {
											$("#feature-title").html(
					...
					onEachFeature : function(feature, layer) {
						if (feature.properties) {
							var content = "<table class='table table-striped table-bordered table-condensed'>"
									...
									+ "</td></tr>"
									+ "<tr><th>Posisi X</th><td>"
									+ feature.properties.POSISIX
									+ "</td></tr>"
									+ "<tr>Posisi Y<th>"
									+ feature.properties.POSISIY
									+ "</td></tr>"
									+ "<tr>Bujur<th>"
									...
									+ "</td></tr>"
									+ "<tr>SPL<th>"
									+ feature.properties.SPL
									+ "</td></tr>"
									+ "<tr>Citra SPL<th>"
									+ feature.properties.CITRA
									+ "</td></tr>"
									+ "<tr>Front<th>"
									+ feature.properties.FRONT + "<table>";
							layer
									.on({
										click : function(e) {
											$("#feature-title")
