...
$.getJSON("data/ikan.geojson", function (data) {
...
var groupedOverlays = {
  "Posisi Kapal-Ikan": {
    "<img src='assets/img/kapal.png' width='24' height='28'>&nbsp; Kapal": kapalLayer,
    "<img src='assets/img/ikan.png' width='24' height='28'>&nbsp; Ikan": museumLayer
  },
  "Prediksi-Pengamatan": {
    "Atmosfer": boroughs,
    "Laut": subwayLines
...
$(document).one("ajaxStop", function () {
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/img/kapal.png' width='24' height='28'>&nbsp;kapals</h4>",
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/img/ikan.png' width='24' height='28'>&nbsp;Museums</h4>",
      suggestion: Handlebars.compile(["{{name}}<br>&nbsp;<small>{{address}}</small>"].join(""))
    }
  }, {
    name: "GeoNames",
